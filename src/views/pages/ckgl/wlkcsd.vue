<template>
  <div class="template-one">
    <div class="title">物料库存锁定表</div>
    <div class="tool-btn">
      <el-button type="primary" icon="el-icon-edit" size="mini">新增</el-button>
      <el-button type="primary" icon="el-icon-share" size="mini">修改</el-button>
      <el-button type="primary" icon="el-icon-delete" size="mini" @click="delRowData()">删除</el-button>
      ...
      <el-button type="primary" icon="el-icon-delete" size="mini">审核</el-button>
    </div>
    <div>
